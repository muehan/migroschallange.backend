...
if __name__ == '__main__':
    customers = []
    paths = [
        'Abverkaufdaten_trx_202001.csv',
        'Abverkaufdaten_trx_202002.csv',
        'Abverkaufdaten_trx_202003.csv',
        'Abverkaufdaten_trx_202004.csv',
        # 'Abverkaufdaten_trx_202005.csv',
        # 'Abverkaufdaten_trx_202006.csv',
        # 'Abverkaufdaten_trx_202007.csv',
        # 'Abverkaufdaten_trx_202008.csv',
        # 'Abverkaufdaten_trx_202009.csv',
        # 'Abverkaufdaten_trx_202010.csv',
        # 'Abverkaufdaten_trx_202011.csv',
        # 'Abverkaufdaten_trx_202012.csv',
        # 'Abverkaufdaten_trx_202101.csv',
        # 'Abverkaufdaten_trx_202102.csv',
        # 'Abverkaufdaten_trx_202103.csv',
        # 'Abverkaufdaten_trx_202104.csv',
        # 'Abverkaufdaten_trx_202105.csv',
        # 'Abverkaufdaten_trx_202106.csv',
        # 'Abverkaufdaten_trx_202107.csv'
    ]
    file = 0

    for path in paths:
        file += 1
        with open('../data/ShoppingCart/' + path) as f:
            next(f)
            i = 0
                        ...
                        if("m_check2" in product):
                            ...
                            if("animal_welfare" in m_check2):
                                ...
                                calcualtedAnimalScore = CalculateScore(
                                    int(currentRating), float(columns[9]))
                                currentBasket.rating_animal_welfare.total += int(
                                    calcualtedAnimalScore)
